...
with st.sidebar:
    ...
    overlapValue = chunk_size*multiplier, -1
    overlapValue = round(overlapValue, -1)
    overlap = st.slider("Overlap", min_value=0, max_value=chunk_size-10, value=overlapValue, step=10)
